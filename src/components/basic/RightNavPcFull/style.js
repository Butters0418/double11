...
export const SHashLink = styled.li`
  button {
    ${tw`relative flex justify-center items-center flex-wrap w-full py-2 text-[15px] font-medium  leading-[1.2] after:block duration-100 whitespace-nowrap text-rightNavText`}
    ${tw`after:(mx-auto mt-3 w-16 h-[1px] bg-[#717171])`}
    p {
